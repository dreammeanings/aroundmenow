...
# 🚀 Around Me Now Expo Production Deployment Script
# Domain: aroundmenowapp.com

echo "🚀 Starting Around Me Now Expo Production Deployment..."
...
echo "📦 Building Expo app for web production..."
npx expo export:web
...
# Create vercel.json for Expo web
cat > vercel.json << EOF
{
  "version": 2,
  "builds": [
...
echo "✅ Created vercel.json for Expo"
...
# 🚀 Expo Deployment Instructions for aroundmenowapp.com
...
echo ""
echo "🎉 Expo deployment preparation complete!"
echo ""
echo "📋 Next steps:"
echo "1. Configure DNS for aroundmenowapp.com"
echo "2. Deploy frontend to Vercel (web-build folder)"
