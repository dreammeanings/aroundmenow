...
export const mockVenues: Venue[] = [
  {
    id: '1',
    name: 'The Blue Note',
    logo: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400',
    description: 'Iconic jazz club featuring live music and craft cocktails',
    latitude: 40.7589,
    longitude: -73.9851,
  ...
  },
  {
    ...
    description: 'Non-profit organization maintaining Central Park',
    latitude: 40.7829,
    longitude: -73.9654,
  ...
  },
  {
    ...
    logo: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400',
    description: 'Craft brewery with tours, tastings, and events',
    latitude: 40.7182,
    longitude: -73.9581,
  ...
  },
  {
    ...
    logo: 'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=400',
    description: 'Modern co-working space and tech community hub',
    latitude: 40.7589,
    longitude: -73.9851,
  ...
  },
  {
    ...
    description: 'Premier comedy club featuring top comedians and entertainment',
    latitude: 40.7589,
    longitude: -73.9851,
    address: '456 Comedy St',
    city: 'Los Angeles',
    state: 'CA',
    zipCode: '90210',
    website: 'https://laughfactory.com',
    socialLinks: {
      instagram: '@laughfactory',
      facebook: 'laughfactory',
...
export const mockEvents: Event[] = [
  {
    ...
    description: 'An evening of smooth jazz with local musicians. Enjoy great music, drinks, and atmosphere.',
    venue: {
      id: 'venue1',
  ...
  },
  {
    ...
    start_date: '2024-12-16T18:00:00Z',
    end_date: '2024-12-16T21:00:00Z',
    start_time: '6:00 PM',
    end_time: '9:00 PM',
    priceRange: 'Free',
  ...
  },
  {
    ...
    description: 'Exhibition featuring local artists with wine and cheese reception.',
    venue: {
      id: 'venue3',
      name: 'The Grand Hall',
    ...
    start_date: '2024-12-17T19:00:00Z',
    end_date: '2024-12-17T22:00:00Z',
    start_time: '7:00 PM',
    end_time: '10:00 PM',
    priceRange: '$',
    tags: ['art', 'culture', 'exhibition'],
    eventTypes: ['art'],
    vibe: ['dressy', 'cultural'],
    latitude: 37.7749,
    longitude: -122.4194,
    trendingScore: 78,
    totalViews: 120,
  ...
  },
  {
    ...
    description: 'Sample the best food trucks in the city with live music and activities.',
    venue: {
      id: 'venue4',
      name: 'The Grand Hall',
      description: 'A beautiful venue for events and celebrations',
    ...
    price: 0,
    venue_name: 'The Grand Hall',
    start_date: '2024-12-18T12:00:00Z',
    ...
    isTrending: true,
    isSaved: false,
    friendsAttending: ['Emma', 'David', 'Lisa'],
    distance: 0.5,
    attendees: 250,
  ...
  },
  {
    ...
    description: 'Free yoga session in the beautiful city park. All levels welcome.',
    venue: {
      id: 'venue5',
      name: 'The Grand Hall',
      description: 'A beautiful venue for events and celebrations',
    ...
    price: 0,
    venue_name: 'The Grand Hall',
    start_date: '2024-12-19T09:00:00Z',
    end_date: '2024-12-19T10:30:00Z',
    start_time: '9:00 AM',
    end_time: '10:30 AM',
    priceRange: 'Free',
    tags: ['wellness', 'yoga', 'outdoor'],
    eventTypes: ['wellness'],
    vibe: ['casual', 'outdoors'],
    latitude: 37.7749,
    longitude: -122.4194,
    trendingScore: 88,
    totalViews: 180,
...
export const mockUser: User = {
  ...
  preferences: {
    radius: 25,
    defaultRadius: 25,
    eventTypes: ['music', 'food', 'wellness'],
    vibe: ['casual', 'outdoors'],
    priceRange: ['Free', '$'],
